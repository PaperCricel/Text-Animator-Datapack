...
# else (word) : split into per-char components (like normal typing), so downstream modes such as
# reverse -- which erase one list element == one character -- still animate correctly.
